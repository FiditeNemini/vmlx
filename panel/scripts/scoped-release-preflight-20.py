...
V5_RELEASE_INTENDED_PATHS_BY_OWNER = {
    "repository_hygiene": ("scripts/check-public-repo-hygiene.sh",),
    "release_metadata": (
        "latest.json",
    ...
    "panel_product": (
        ...
        "panel/src/renderer/src/components/chat/chatSettingsCompatibility.ts",
        ...
        "panel/src/shared/jangQuantization.ts",
        "panel/src/shared/reasoningEffortPolicy.ts",
        "panel/src/shared/remoteModelCapabilities.ts",
    ...
    "panel_tests": (
        ...
        "panel/tests/jang-quantization-label.test.ts",
        ...
        "panel/tests/remote-model-capabilities.test.ts",
    ...
    "python_tests": (
        ...
        "tests/test_block_disk_write_fence.py",
        ...
        "tests/test_scheduler_cache_truth.py",
        ...
        "tests/test_scoped_release_preflight_20.py",
...
def locked_jang_version() -> str | None:
    text = (ROOT / "uv.lock").read_text(encoding="utf-8")
    match = re.search(
...
def validate_versions(failures: list[str]) -> dict[str, Any]:
    ...
    jang_lock = locked_jang_version()
    require(
        jang_lock == JANG_VERSION,
        failures,
        f"uv_lock_jang={jang_lock!r}, expected {JANG_VERSION}",
    )
    values["uv_lock_jang"] = jang_lock
    return values
