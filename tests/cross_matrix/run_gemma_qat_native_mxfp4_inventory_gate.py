...
REJECTED_INSTALLED_APP_UI_PROOFS = {
    "gemma4_26b_vl": Path(
        "build/private-evidence/current-real-ui-installed-app-gemma4-26b-vl-mxfp4-responses-tools-cachecontrols-bundled-python-reasoning-explicit-20260610-proof.json"
    ),
    "gemma4_31v_or_31b_vl": Path(
        "build/private-evidence/current-real-ui-installed-app-gemma4-31b-mxfp4-responses-tools-cachecontrols-bundled-python-reasoning-explicitbrief-max1024-20260610-proof.json"
    ),
}
