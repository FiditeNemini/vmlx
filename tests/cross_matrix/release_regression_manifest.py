...
CURRENT_REAL_UI_LIVE_MODEL_PROOF_ROWS = {
    ...
    "zaya_text_responses_tools": {
        "proof": "build/private-evidence/current-real-ui-live-model-zaya-text-responses-stricttools-cachecontrols-20260530-proof.json",
        "chat_screenshot": "build/private-evidence/current-real-ui-live-model-zaya-text-responses-stricttools-cachecontrols-20260530-chat.png",
        "model_path": "/Users/example/models/JANGQ/ZAYA1-8B-MXFP4",
        "model_name": "ZAYA1-8B-MXFP4",
        "family": "zaya_text",
    },
