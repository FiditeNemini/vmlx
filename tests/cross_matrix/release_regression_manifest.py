...
This is the durable index for the broad regression suite The project requires. It is
...
CURRENT_REAL_UI_LIVE_MODEL_PROOF_ARTIFACTS = {
    ...
    "chat_screenshot": "build/private-evidence/current-real-ui-live-model-zaya-text-20260526-chat.png",
}
...
CURRENT_REAL_UI_LIVE_MODEL_PROOF_ROWS = {
    ...
    "zaya_text_cachecontrols": {
        "proof": "build/private-evidence/current-real-ui-live-model-zaya-text-cachecontrols-20260527-proof.json",
        "chat_screenshot": "build/private-evidence/current-real-ui-live-model-zaya-text-cachecontrols-20260527-chat.png",
        "model_path": "/Volumes/EricsLLMDrive/jangq-ai/Zaya-8B-JANG_4M",
        "model_name": "Zaya-8B-JANG_4M",
        "family": "zaya_text",
    },
    # 2026-08 hardware transition: rebuilt on the current drive bundle (previous-machine artifact retired). Current bundle picks run_applescript over run_command and goes silent after a failed call (ledger row 26/27).
    "zaya_text_responses_tools": {
        "proof": "build/private-evidence/current-real-ui-live-model-zaya-text-responses-tools-cachecontrols-20260815-proof.json",
        "chat_screenshot": "build/private-evidence/current-real-ui-live-model-zaya-text-responses-tools-cachecontrols-20260815-chat.png",
        "model_path": "/Volumes/EricsLLMDrive/jangq-ai/Zaya-8B-JANG_4M",
        "model_name": "Zaya-8B-JANG_4M",
        "family": "zaya_text",
    },
    # 2026-08 hardware transition: rebuilt on the current drive bundle (previous-machine artifact retired).
    "gemma4": {
        "proof": "build/private-evidence/current-real-ui-live-model-gemma4-responses-stricttools-max768-visible-20260815-proof.json",
        "chat_screenshot": "build/private-evidence/current-real-ui-live-model-gemma4-responses-stricttools-max768-visible-20260815-chat.png",
        "model_path": "/Volumes/EricsLLMDrive/dealignai/Gemma-4-26B-A4B-it-JANG_4M-CRACK",
        "model_name": "Gemma-4-26B-A4B-it-JANG_4M-CRACK",
        "family": "gemma4",
    },
    "gemma4_reasoning": {
        "proof": "build/private-evidence/current-real-ui-live-model-gemma4-responses-reasoningonly-max768-visible-20260815-proof.json",
        "chat_screenshot": "build/private-evidence/current-real-ui-live-model-gemma4-responses-reasoningonly-max768-visible-20260815-chat.png",
        "model_path": "/Volumes/EricsLLMDrive/dealignai/Gemma-4-26B-A4B-it-JANG_4M-CRACK",
        "model_name": "Gemma-4-26B-A4B-it-JANG_4M-CRACK",
        "family": "gemma4",
    },
    "gemma4_cachecontrols": {
        "proof": "build/private-evidence/current-real-ui-live-model-gemma4-cachecontrols-l2storage-20260815-proof.json",
        "chat_screenshot": "build/private-evidence/current-real-ui-live-model-gemma4-cachecontrols-l2storage-20260815-chat.png",
        "model_path": "/Volumes/EricsLLMDrive/dealignai/Gemma-4-26B-A4B-it-JANG_4M-CRACK",
        "model_name": "Gemma-4-26B-A4B-it-JANG_4M-CRACK",
        "family": "gemma4",
    },
    # 2026-08 hardware transition: Qwen3.6-27B-JANG_4M-MTP does not exist on current hardware; the 35B MXFP8-MTP lane carries the qwen36 family evidence.
    "qwen36_mxfp4_crack": {
        "proof": "build/private-evidence/current-real-ui-live-model-qwen36-35b-mxfp8-mtp-responses-tools-cachecontrols-deterministic-mtp-20260815-proof.json",
        "chat_screenshot": "build/private-evidence/current-real-ui-live-model-qwen36-35b-mxfp8-mtp-responses-tools-cachecontrols-deterministic-mtp-20260815-chat.png",
        "model_path": "/Volumes/EricsLLMDrive/dealignai/Qwen3.6-35B-A3B-MXFP8-CRACK-MTP",
        "model_name": "Qwen3.6-35B-A3B-MXFP8-CRACK-MTP",
        "family": "qwen36",
    },
    "qwen36_mxfp4_crack_video": {
        "proof": "build/private-evidence/current-real-ui-live-model-qwen36-35b-mxfp8-mtp-responses-tools-video-reasoning-cachecontrols-20260815-proof.json",
        "chat_screenshot": "build/private-evidence/current-real-ui-live-model-qwen36-35b-mxfp8-mtp-responses-tools-video-reasoning-cachecontrols-20260815-chat.png",
        "model_path": "/Volumes/EricsLLMDrive/dealignai/Qwen3.6-35B-A3B-MXFP8-CRACK-MTP",
        "model_name": "Qwen3.6-35B-A3B-MXFP8-CRACK-MTP",
        "family": "qwen36",
    },
    "qwen36_mxfp4_crack_responses_tools_reasoning_image_cachecontrols": {
        "proof": "build/private-evidence/current-real-ui-live-model-qwen36-35b-mxfp8-mtp-responses-tools-image-reasoning-cachecontrols-20260815-proof.json",
        "chat_screenshot": "build/private-evidence/current-real-ui-live-model-qwen36-35b-mxfp8-mtp-responses-tools-image-reasoning-cachecontrols-20260815-chat.png",
        "model_path": "/Volumes/EricsLLMDrive/dealignai/Qwen3.6-35B-A3B-MXFP8-CRACK-MTP",
        "model_name": "Qwen3.6-35B-A3B-MXFP8-CRACK-MTP",
        "family": "qwen36",
    },
    ...
    "minimax_m27_small_jangtq": {
        "proof": "build/private-evidence/current-real-ui-live-model-minimax-m27-small-jangtq-20260815-proof.json",
        "chat_screenshot": "build/private-evidence/current-real-ui-live-model-minimax-m27-small-jangtq-20260815-chat.png",
        "model_path": "/Volumes/EricsLLMDrive/jangq-ai/MiniMax-M2.7-Small-JANGTQ",
        "model_name": "MiniMax-M2.7-Small-JANGTQ",
        "family": "minimax",
    },
    "minimax_m27_small_responses_tools_cachecontrols": {
        "proof": "build/private-evidence/current-real-ui-live-model-minimax-m27-small-responses-tools-cachecontrols-20260815-proof.json",
        "chat_screenshot": "build/private-evidence/current-real-ui-live-model-minimax-m27-small-responses-tools-cachecontrols-20260815-chat.png",
        "model_path": "/Volumes/EricsLLMDrive/jangq-ai/MiniMax-M2.7-Small-JANGTQ",
        "model_name": "MiniMax-M2.7-Small-JANGTQ",
        "family": "minimax",
    },
    "minimax_m27_small_responses_stricttools_cachecontrols": {
        "proof": "build/private-evidence/current-real-ui-live-model-minimax-m27-small-responses-stricttools-cachecontrols-20260815-proof.json",
        "chat_screenshot": "build/private-evidence/current-real-ui-live-model-minimax-m27-small-responses-stricttools-cachecontrols-20260815-chat.png",
        "model_path": "/Volumes/EricsLLMDrive/jangq-ai/MiniMax-M2.7-Small-JANGTQ",
        "model_name": "MiniMax-M2.7-Small-JANGTQ",
        "family": "minimax",
    },
    "minimax_m27_small_installed_responses_tools_cachecontrols_singleid": {
        "proof": "build/private-evidence/current-real-ui-installed-app-minimax-m27-small-responses-tools-cachecontrols-singleid-20260815-proof.json",
        "chat_screenshot": "build/private-evidence/current-real-ui-installed-app-minimax-m27-small-responses-tools-cachecontrols-singleid-20260815-chat.png",
        "model_path": "/Volumes/EricsLLMDrive/jangq-ai/MiniMax-M2.7-Small-JANGTQ",
        "model_name": "MiniMax-M2.7-Small-JANGTQ",
        "family": "minimax",
    },
    ...
    "nemotron_omni_nano_jangtq": {
        "proof": "build/private-evidence/current-real-ui-live-model-nemotron-omni-nano-jangtq-20260815-proof.json",
        "chat_screenshot": "build/private-evidence/current-real-ui-live-model-nemotron-omni-nano-jangtq-20260815-chat.png",
        "model_path": "/Volumes/EricsLLMDrive/dealignai/Nemotron-Omni-Nano-JANGTQ-CRACK",
        "model_name": "Nemotron-Omni-Nano-JANGTQ-CRACK",
        "family": "nemotron_omni",
    },
    "nemotron_omni_nano_responses_tools_reasoning_cachecontrols": {
        "proof": "build/private-evidence/current-real-ui-installed-app-nemotron-omni-nano-responses-tools-reasoning-cachecontrols-20260815-proof.json",
        "chat_screenshot": "build/private-evidence/current-real-ui-installed-app-nemotron-omni-nano-responses-tools-reasoning-cachecontrols-20260815-chat.png",
        "model_path": "/Volumes/EricsLLMDrive/dealignai/Nemotron-Omni-Nano-JANGTQ-CRACK",
        "model_name": "Nemotron-Omni-Nano-JANGTQ-CRACK",
        "family": "nemotron_omni",
    },
    "nemotron_omni_nano_responses_reasoning": {
        "proof": "build/private-evidence/current-real-ui-live-model-nemotron-omni-nano-responses-reasoning-20260815-proof.json",
        "chat_screenshot": "build/private-evidence/current-real-ui-live-model-nemotron-omni-nano-responses-reasoning-20260815-chat.png",
        "model_path": "/Volumes/EricsLLMDrive/dealignai/Nemotron-Omni-Nano-JANGTQ-CRACK",
        "model_name": "Nemotron-Omni-Nano-JANGTQ-CRACK",
        "family": "nemotron_omni",
    },
    "nemotron_omni_nano_responses_tools_filesemantic": {
        "proof": "build/private-evidence/current-real-ui-live-model-nemotron-omni-nano-responses-stricttools-cachecontrols-20260815-proof.json",
        "chat_screenshot": "build/private-evidence/current-real-ui-live-model-nemotron-omni-nano-responses-stricttools-cachecontrols-20260815-chat.png",
        "model_path": "/Volumes/EricsLLMDrive/dealignai/Nemotron-Omni-Nano-JANGTQ-CRACK",
        "model_name": "Nemotron-Omni-Nano-JANGTQ-CRACK",
        "family": "nemotron_omni",
    },
    ...
    "step37_flash_jang2l": {
        ...
        "chat_screenshot": "build/private-evidence/current-real-ui-live-model-step37-jangk-devbuild-tools-image-cache-20260815-chat.png",
        "model_path": "/Volumes/EricsLLMDrive/dealignai/Step-3.7-Flash-JANG_K-CRACK",
        "model_name": "Step-3.7-Flash-JANG_K-CRACK",
        "family": "step37",
    },
    "step37_flash_jang2l_reasoning": {
        "proof": "build/private-evidence/current-real-ui-live-model-step37-jangk-responses-reasoning-max768-20260815-proof.json",
        "chat_screenshot": "build/private-evidence/current-real-ui-live-model-step37-jangk-responses-reasoning-max768-20260815-chat.png",
        "model_path": "/Volumes/EricsLLMDrive/dealignai/Step-3.7-Flash-JANG_K-CRACK",
        "model_name": "Step-3.7-Flash-JANG_K-CRACK",
        "family": "step37",
    },
    "step37_flash_jang2l_l2storage": {
        "proof": "build/private-evidence/current-real-ui-live-model-step37-jangk-cachecontrols-l2storage-20260815-proof.json",
        "chat_screenshot": "build/private-evidence/current-real-ui-live-model-step37-jangk-cachecontrols-l2storage-20260815-chat.png",
        "model_path": "/Volumes/EricsLLMDrive/dealignai/Step-3.7-Flash-JANG_K-CRACK",
        "model_name": "Step-3.7-Flash-JANG_K-CRACK",
        "family": "step37",
    },
    "step37_flash_jang2l_tool_l2storage": {
        "proof": "build/private-evidence/current-real-ui-live-model-step37-jangk-responses-tools-l2storage-pagedlocked-20260815-proof.json",
        "chat_screenshot": "build/private-evidence/current-real-ui-live-model-step37-jangk-responses-tools-l2storage-pagedlocked-20260815-chat.png",
        "model_path": "/Volumes/EricsLLMDrive/dealignai/Step-3.7-Flash-JANG_K-CRACK",
        "model_name": "Step-3.7-Flash-JANG_K-CRACK",
        "family": "step37",
    },
    # 2026-08 hardware transition: rebuilt on the current drive bundle (previous-machine artifact retired).
    "lfm25_moe_a1b": {
        "proof": "build/private-evidence/current-real-ui-live-model-lfm25-mxfp8-responses-tools-cachecontrols-20260815-proof.json",
        "chat_screenshot": "build/private-evidence/current-real-ui-live-model-lfm25-mxfp8-responses-tools-cachecontrols-20260815-chat.png",
        "model_path": "/Volumes/EricsLLMDrive/dealignai/LFM2.5-8B-A1B-MXFP8-CRACK",
    ...
    # 2026-08-17: dots3-note added as TRACKED evidence, not as a required
    # family. The family is deliberately absent from
    # REQUIRED_REAL_UI_LIVE_MODEL_SURFACES_BY_FAMILY and from the matrix's
    # required_families, so this row records the proof without being able to
    # create a new release blocker. Its run is responses + builtin tools +
    # reasoning + cache controls with ZERO assertion failures and 21 surfaces,
    # on its designed SSD-only lane (registry sets usePagedCache false) with
    # real block-disk reuse.
    "dots3_note_responses_tools_reasoning": {
        "proof": "build/private-evidence/current-real-ui-live-model-dots3-note-responses-tools-reasoning-cachecontrols-20260817-proof.json",
        "chat_screenshot": "build/private-evidence/current-real-ui-live-model-dots3-note-responses-tools-reasoning-cachecontrols-20260817-chat.png",
        "model_path": "/Volumes/EricsLLMDrive/models/dots3-note-prev-JANG",
        "model_name": "dots3-note-prev-JANG",
        "family": "dots3_note",
    },
    "dsv4_flash_0731": {
...
REQUIRED_REAL_UI_LIVE_MODEL_VARIANTS_BY_FAMILY = {
    # 2026-08 hardware transition: the 27B JANG_4M-MTP bundle does not exist on
    # current hardware; the 35B MXFP8-CRACK-MTP lane carries qwen36 evidence.
    "qwen36": {
        "model_names": {
...
CURRENT_COVERED_LIVE_SMOKE_ROW_EXPECTATIONS: dict[str, dict[str, Any]] = {
    "zaya_text_mxfp4": {
        # 2026-08 hardware transition: current text-lane bundle.
        "name": "Zaya-8B-JANG_4M",
        "model_type": "zaya",
        "is_mllm": False,
...
_ROWS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "proves": [
            ...
            "DSV4 native composite prefix/paged/L2 reuse defaults off until cached output matches cold prefill",
    ...
    },
    {
        ...
        "proves": [
            ...
            "DSV4 degraded DSML variants from historical native-cache diagnostics are repaired only when schema-valid",
            "live DSV4 write_file DSML degradation is repaired schema-safely",
            "historical native-cache loop reaches three tools but still fails exact WebGLRenderer fidelity",
            "explicit-thinking DSV4 native-cache diagnostic remains review: thinking does not clear tool ordering, final DONE, or exact scene.js fidelity",
    ...
    },
    {
        ...
        "proves": [
            ...
            "Native JANG DSV4 pool quant codec appends only newly generated CSA/HCA pool rows instead of requantizing the whole accumulated pool",
            "Native DSV4 pool quant reads reuse a materialized pool view instead of dequantizing and concatenating historical CSA/HCA pool segments on every read",
            "DSV4 product sessions default to full prefill and reject unsafe shortened-key composite stores",
            "DSV4 panel UI/env mapping keeps native pool quant family-scoped, follows the bundle default, and preserves explicit user opt-out",
            "Historical DSV4 timing probes remain diagnostics and do not clear current native positive-hit equivalence",
            ...
            "Panel session launch builder keeps DSV4 composite reuse fail-closed, preserves DSV4-only cache boundaries, Qwen3.6 hybrid and Mamba paged-cache forcing, and regular KV stale saved false semantics",
        ],
        "commands": [
    ...
    },
    {
        ...
        "proves": [
            ...
            "live public release-surface mode checks raw GitHub latest.json, mlx.studio/update/latest.json, PyPI files, and GitHub release DMG asset digest against the canonical app manifest after a release is cut",
            ...
            "live public release-surface mode binds the source repo release tag to the source commit in the immutable final notarization manifest rather than a later metadata-only source head",
        ],
        "commands": [
    ...
    },
    {
        ...
        "artifacts": [
            "build/private-evidence/pr-triage/2026-05-21-open-pr-intake.md",
    ...
    },
    {
        ...
        "proves": [
            ...
            "Historical DSV4 JANGTQ-K bundled smoke retained exact ACK, native prefix-cache repeat, multi-turn recall, and reasoning-on visible final answer; current product sessions are fail-closed and native reuse equivalence remains deferred",
    ...
    },
    {
        ...
        "commands": [
            "VMLINUX_REAL_UI_MODEL_PATH=/Volumes/EricsLLMDrive/jangq-ai/Zaya-8B-JANG_4M VMLINUX_REAL_UI_MAX_TOKENS=400 VMLINUX_REAL_UI_PROOF_BASENAME=current-real-ui-live-model-zaya-text-20260526 node panel/scripts/live-real-ui-model-proof.mjs",
            "VMLINUX_REAL_UI_MODEL_PATH=/Volumes/EricsLLMDrive/jangq-ai/Zaya-8B-JANG_4M VMLINUX_REAL_UI_MAX_TOKENS=400 VMLINUX_REAL_UI_PROOF_BASENAME=current-real-ui-live-model-zaya-text-cachecontrols-20260527 VMLINUX_REAL_UI_CHECK_SERVER_CACHE_CONTROLS=1 node panel/scripts/live-real-ui-model-proof.mjs",
            "VMLINUX_REAL_UI_MODEL_PATH=/Volumes/EricsLLMDrive/jangq-ai/Zaya-8B-JANG_4M VMLINUX_REAL_UI_PROOF_BASENAME=current-real-ui-live-model-zaya-text-responses-tools-cachecontrols-20260815 VMLINUX_REAL_UI_WIRE_API=responses VMLINUX_REAL_UI_BUILTIN_TOOLS=1 VMLINUX_REAL_UI_TEMPERATURE=0 VMLINUX_REAL_UI_MAX_TOKENS=400 VMLINUX_REAL_UI_MAX_TOOL_ITERATIONS=8 VMLINUX_REAL_UI_CHECK_SERVER_CACHE_CONTROLS=1 node panel/scripts/live-real-ui-model-proof.mjs",
        ...
        "artifacts": [
            ...
            "build/private-evidence/current-real-ui-live-model-zaya-text-20260526-chat.png",
            "build/private-evidence/current-real-ui-live-model-zaya-text-cachecontrols-20260527-proof.json",
            "build/private-evidence/current-real-ui-live-model-zaya-text-cachecontrols-20260527-chat.png",
            "build/private-evidence/current-real-ui-live-model-zaya-text-responses-runcommand-tools-20260527-proof.json",
            "build/private-evidence/current-real-ui-live-model-zaya-text-responses-runcommand-tools-20260527-chat.png",
            "build/private-evidence/current-real-ui-live-model-zaya-vl-image-20260527-proof.json",
            "build/private-evidence/current-real-ui-live-model-zaya-vl-image-20260527-chat.png",
            "build/private-evidence/current-real-ui-live-model-ling-bailing-jangtq-20260526-proof.json",
            "build/private-evidence/current-real-ui-live-model-ling-bailing-jangtq-20260526-chat.png",
            "build/private-evidence/current-real-ui-live-model-ling-bailing-jangtq-responses-filesemantic-20260530-proof.json",
            "build/private-evidence/current-real-ui-live-model-ling-bailing-jangtq-responses-filesemantic-20260530-chat.png",
            "build/current-lfm25-direct-responses-runcommand-cache-boundary-20260530.json",
            "build/private-evidence/current-real-ui-live-model-gemma4-26b-jang4m-20260526-proof.json",
            "build/private-evidence/current-real-ui-live-model-gemma4-26b-jang4m-20260526-chat.png",
            "build/private-evidence/diagnostic-real-ui-live-model-gemma4-responses-tools-reasoning-20260527-proof.json",
            "build/private-evidence/diagnostic-real-ui-live-model-gemma4-responses-tools-reasoning-20260527-chat.png",
            "build/private-evidence/current-real-ui-live-model-qwen36-27b-jang4m-mtp-responses-tools-cachecontrols-deterministic-mtp-20260607-proof.json",
            "build/private-evidence/current-real-ui-live-model-qwen36-27b-jang4m-mtp-responses-tools-cachecontrols-deterministic-mtp-20260607-chat.png",
            "build/media-fixtures/red-64x64-1s.mp4",
            "build/private-evidence/current-real-ui-live-model-minimax-m27-small-jangtq-20260527-proof.json",
            "build/private-evidence/current-real-ui-live-model-minimax-m27-small-jangtq-20260527-chat.png",
            "build/private-evidence/current-real-ui-live-model-minimax-m27-small-responses-tools-cachecontrols-localonly-20260527-proof.json",
            "build/private-evidence/current-real-ui-live-model-minimax-m27-small-responses-tools-cachecontrols-localonly-20260527-chat.png",
            "build/private-evidence/diagnostic-real-ui-live-model-minimax-m27-jangtq-k-issue179-20260527-proof.json",
            "build/private-evidence/diagnostic-real-ui-live-model-minimax-m27-jangtq-k-issue179-20260527-chat.png",
            "build/private-evidence/diagnostic-installed-ui-live-model-minimax-m27-jangtq-k-issue179-20260527-proof.json",
            "build/private-evidence/diagnostic-installed-ui-live-model-minimax-m27-jangtq-k-issue179-20260527-chat.png",
            "build/private-evidence/diagnostic-installed-ui-live-model-minimax-m27-jangtq-k-issue179-hi-auto-20260527-proof.json",
            "build/private-evidence/diagnostic-installed-ui-live-model-minimax-m27-jangtq-k-issue179-hi-auto-20260527-chat.png",
            "build/private-evidence/diagnostic-installed-ui-live-model-minimax-m27-jangtq-k-issue179-hi-thinking-20260527-proof.json",
            "build/private-evidence/diagnostic-installed-ui-live-model-minimax-m27-jangtq-k-issue179-hi-thinking-20260527-chat.png",
            "build/private-evidence/diagnostic-installed-ui-live-model-minimax-m27-jangtq-k-issue179-512-20260527-proof.json",
            "build/private-evidence/diagnostic-installed-ui-live-model-minimax-m27-jangtq-k-issue179-512-20260527-chat.png",
            ...
            "build/private-evidence/current-real-ui-live-model-nemotron-omni-nano-jangtq-20260527-proof.json",
            "build/private-evidence/current-real-ui-live-model-nemotron-omni-nano-jangtq-20260527-chat.png",
            "build/private-evidence/current-real-ui-installed-app-nemotron-omni-nano-responses-tools-reasoning-cachecontrols-localonly-20260601-proof.json",
            "build/private-evidence/current-real-ui-installed-app-nemotron-omni-nano-responses-tools-reasoning-cachecontrols-localonly-20260601-chat.png",
            "build/private-evidence/diagnostic-real-ui-live-model-nemotron-omni-nano-responses-reasoning-20260531-proof.json",
            "build/private-evidence/diagnostic-real-ui-live-model-nemotron-omni-nano-responses-reasoning-20260531-chat.png",
            "build/private-evidence/current-real-ui-live-model-nemotron-omni-nano-responses-stricttools-cachecontrols-exact-finalizer-20260531-proof.json",
            "build/private-evidence/current-real-ui-live-model-nemotron-omni-nano-responses-stricttools-cachecontrols-exact-finalizer-20260531-chat.png",
            "build/private-evidence/current-real-ui-live-model-hy3-jangtq2-20260526-proof.json",
            "build/private-evidence/current-real-ui-live-model-hy3-jangtq2-20260526-chat.png",
            "build/private-evidence/current-real-ui-live-model-hy3-jangtq2-responses-reasoning-20260527-proof.json",
            "build/private-evidence/current-real-ui-live-model-hy3-jangtq2-responses-reasoning-20260527-chat.png",
            "build/private-evidence/current-real-ui-live-model-hy3-jangtq2-responses-tools-thinkingoff-toolforced-20260527-proof.json",
            "build/private-evidence/current-real-ui-live-model-hy3-jangtq2-responses-tools-thinkingoff-toolforced-20260527-chat.png",
            "build/private-evidence/current-real-ui-live-model-hy3-jangtq2-responses-tools-filesemantic-20260530-proof.json",
            "build/private-evidence/current-real-ui-live-model-hy3-jangtq2-responses-tools-filesemantic-20260530-chat.png",
        ],
    },
    {
...
def _validate_current_issue179_minimax_k_live_probe_memory_preflight(
    ...
    if skipped_for_memory:
        ...
        if payload.get("launch_allowed") is not False:
            failures.append("launch_allowed_not_false")
    # 2026-08 hardware transition: the reporter's exact MiniMax-M2.7-JANGTQ_K
    # bundle is not on current hardware; MiniMax-M2.7-JANG_K-CRACK is the
    # nearest current lane and is what the .29-campaign preflight launched.
    if not (
        model_path.endswith("MiniMax-M2.7-JANGTQ_K")
        or model_path.endswith("MiniMax-M2.7-JANG_K-CRACK")
    ):
