...
CURRENT_MIMO_V2_JANGTQ2_INSTALLED_RESPONSES_TOOLS_CACHE_ARTIFACT = (
    "build/private-evidence/current-real-ui-installed-app-mimo-v25-jangtq2-responses-tools-cache-deterministic-printf-bundled-python-20260611-proof.json"
)
CURRENT_MIMO_V2_JANG2L_INSTALLED_RESPONSES_TOOLS_CACHE_ARTIFACT = (
    "build/private-evidence/current-real-ui-installed-app-mimo-v25-jang2l-responses-tools-cache-deterministic-printf-bundled-python-20260611-proof.json"
)
CURRENT_MIMO_V2_JANGTQ2_INSTALLED_MEDIA_L2_ARTIFACT = (
    "build/private-evidence/current-real-ui-installed-app-mimo-v25-jangtq2-image-overlay-after-rebuild-pass-20260611-proof.json"
)
