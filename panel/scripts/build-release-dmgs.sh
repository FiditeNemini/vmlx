...
RELEASE_CODESIGN_IDENTITY="${VMLX_RELEASE_CODESIGN_IDENTITY:-${VMLINUX_RELEASE_CODESIGN_IDENTITY:-${CSC_NAME:-$EXPECTED_CODESIGN_IDENTITY}}}"
...
if [[ "$RELEASE_SCOPE" == "r18_production" ]]; then
  ...
  export CSC_NAME="$EXPECTED_CODESIGN_IDENTITY"
else
