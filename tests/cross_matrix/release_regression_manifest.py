...
_ROWS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "commands": [
            ...
            ".venv/bin/python tests/cross_matrix/run_release_surface_contract.py --live-public --public-manifest $VMLX_PUBLIC_RELEASE_MANIFEST --final-notary-manifest $VMLX_R18_FINAL_NOTARY_MANIFEST --final-notary-manifest-sha256 $VMLX_R18_FINAL_NOTARY_MANIFEST_SHA256 --out build/current-release-surface-contract-20260522-live-public-v1548.json",
            ".venv/bin/python tests/cross_matrix/run_release_surface_contract.py --live-public --public-manifest $VMLX_PUBLIC_RELEASE_MANIFEST --final-notary-manifest $VMLX_R18_FINAL_NOTARY_MANIFEST --final-notary-manifest-sha256 $VMLX_R18_FINAL_NOTARY_MANIFEST_SHA256 --out build/current-release-surface-contract-20260524-live-source-tag-parity.json",
        ],
        "artifacts": [
