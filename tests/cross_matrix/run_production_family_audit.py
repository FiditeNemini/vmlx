...
ROWS: list[ModelRow] = [
    ...
    ModelRow(
        ...
        notes=[
            ...
            "deepseek_v4_v10_delta composite-state serialization, not generic KV blocks"
        ],
    ),
    ModelRow(
        id="dsv4_jang_local",
    ...
    ModelRow(
        ...
        notes=[
            ...
            "with deepseek_v4_v10_delta paged-prefix/L2 serialization; generic "
...
def live_audit(row: ModelRow, py: Path, port: int, timeout_load: int, keep_running: bool = False) -> dict[str, Any]:
    ...
    if row.family == "deepseek_v4":
        check(
            ...
            and "deepseek_v4_v10_delta" in log_text,
    ...
    if row.cache_profile == "zaya_cca":
        ...
        check(
            ...
            and native_caps.get("schema") == "deepseek_v4_v10_delta"
