...
CURRENT_REAL_UI_LIVE_MODEL_PROOF_ROWS = {
    ...
    "nemotron_omni_nano_responses_tools_reasoning_cachecontrols": {
        "proof": "build/private-evidence/current-real-ui-live-model-nemotron-omni-nano-responses-tools-reasoning-cachecontrols-localonly-20260527-proof.json",
        "chat_screenshot": "build/private-evidence/current-real-ui-live-model-nemotron-omni-nano-responses-tools-reasoning-cachecontrols-localonly-20260527-chat.png",
        "model_path": "/Users/example/models/dealign.ai/Nemotron-Omni-Nano-JANGTQ-CRACK",
        "model_name": "Nemotron-Omni-Nano-JANGTQ-CRACK",
        "family": "nemotron_omni",
    },
...
_ROWS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "artifacts": [
            ...
            "build/private-evidence/current-real-ui-live-model-nemotron-omni-nano-responses-tools-reasoning-cachecontrols-localonly-20260527-proof.json",
            "build/private-evidence/current-real-ui-live-model-nemotron-omni-nano-responses-tools-reasoning-cachecontrols-localonly-20260527-chat.png",
