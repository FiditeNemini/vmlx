...
QWEN27_INSTALLED_VIDEO = Path(
    "build/private-evidence/current-real-ui-installed-app-qwen36-27b-jang4m-mtp-responses-tools-video-reasoning-cachecontrols-max512-20260607-proof.json"
)
...
QWEN35_INSTALLED_VIDEO = Path(
    "build/private-evidence/current-real-ui-installed-app-qwen36-35b-mxfp8-mtp-responses-tools-video-reasoning-cachecontrols-max512-20260607-proof.json"
)
