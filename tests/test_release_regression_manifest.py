...
def test_release_regression_manifest_real_ui_live_model_rows_include_ling_bailing_slice():
    ...
    assert (
        ...
        == "build/private-evidence/current-real-ui-live-model-step37-jang2l-responses-tools-image-cachecontrols-after-direct-media-tool-filter-20260531-proof.json"
    )
    ...
    assert (
        ...
        == "build/private-evidence/current-real-ui-live-model-step37-jang2l-responses-tools-l2storage-integrated-20260531-proof.json"
    )
    ...
    assert (
        ...
        == "build/private-evidence/current-real-ui-live-model-lfm25-moe-a1b-jang2l-responses-delta-longtool-20260531-proof.json"
    )
