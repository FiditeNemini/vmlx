...
ROWS: list[ModelRow] = [
    ...
    ModelRow(
        ...
        notes=[
            ...
            "deepseek_v4_v9 composite-state serialization, not generic KV blocks"
        ],
    ),
    ModelRow(
        id="dsv4_jang_local",
    ...
    ModelRow(
        ...
        notes=[
            ...
            "with deepseek_v4_v9 paged-prefix/L2 serialization; generic "
...
def capability_endpoint_contract_ok(row: ModelRow, caps: Any) -> bool:
    ...
    return (
        ...
        and native.get("schema") == "deepseek_v4_v9"
...
def live_audit(row: ModelRow, py: Path, port: int, timeout_load: int, keep_running: bool = False) -> dict[str, Any]:
    ...
    if row.family == "deepseek_v4":
        check(
            ...
            and "deepseek_v4_v9" in log_text,
            "DSV4 must keep paged/L2 cache on and use the deepseek_v4 v9 composite-state schema",
        )
        check(
    ...
    if row.cache_profile == "zaya_cca":
        ...
        check(
            ...
            and native_caps.get("schema") == "deepseek_v4_v9"
