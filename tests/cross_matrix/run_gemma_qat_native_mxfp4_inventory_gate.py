...
INSTALLED_APP_UI_PROOFS = {
    "gemma4_e2b_qat_jang4m": Path(
        "build/private-evidence/current-real-ui-installed-app-gemma4-e2b-qat-jang4m-responses-tools-cachecontrols-visible-chat-20260610-proof.json"
    ),
    "gemma4_e4b_qat_jang4m": Path(
        "build/private-evidence/current-real-ui-installed-app-gemma4-e4b-qat-jang4m-responses-tools-cachecontrols-visible-chat-20260610-proof.json"
    ),
    "gemma4_12b_qat_jang4m": Path(
        "build/private-evidence/current-real-ui-installed-app-gemma4-12b-qat-jang4m-responses-tools-cachecontrols-visible-chat-20260610-proof.json"
    ),
    "gemma4_26b_qat_jang4m": Path(
        "build/private-evidence/current-real-ui-installed-app-gemma4-26b-qat-jang4m-responses-tools-cachecontrols-visible-chat-20260610-proof.json"
    ),
    "gemma4_31b_qat_jang4m": Path(
        "build/private-evidence/current-real-ui-installed-app-gemma4-31b-qat-jang4m-responses-tools-cachecontrols-visible-chat-short-second-tool-20260610-proof.json"
    ),
    "gemma4_e2b_qat_native_mxfp4": Path(
        "build/private-evidence/current-real-ui-installed-app-gemma4-e2b-mxfp4-responses-tools-cachecontrols-bundled-python-reasoning-shorttool-20260610-proof.json"
    ),
    "gemma4_e4b_qat_native_mxfp4": Path(
        "build/private-evidence/current-real-ui-installed-app-gemma4-e4b-mxfp4-responses-tools-cachecontrols-bundled-python-reasoning-strictfinal-20260610-proof.json"
    ),
    "gemma4_12b_native_mxfp4": Path(
        "build/private-evidence/current-real-ui-installed-app-gemma4-12b-mxfp4-responses-tools-cachecontrols-bundled-python-reasoning-20260610-proof.json"
    ),
    "gemma4_26b_vl": Path(
        "build/private-evidence/current-real-ui-installed-app-gemma4-26b-vl-mxfp4-responses-tools-cachecontrols-bundled-python-sessionlogs-reasoning-probe-20260611-proof.json"
    ),
    "gemma4_31v_or_31b_vl": Path(
        "build/private-evidence/current-real-ui-installed-app-gemma4-31b-mxfp4-responses-tools-cachecontrols-bundled-python-sessionlogs-reasoning-probe-20260611-proof.json"
    ),
}
